                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10 md:gap-14 items-center">
                    ...
                    <div className="space-y-6 text-center md:text-left">
                        ...
                        <p className="text-gray-600 text-base sm:text-lg max-w-lg mx-auto md:mx-0">
                            ...
                            Explore latest fashion, electronics, accessories and more.
                        </p>
                            ...
                            <div className="p-5 flex flex-col flex-1 justify-between">
                                ...
                                <div>
                                    <div className="text-yellow-400 text-sm tracking-tight font-bold">
                                        ★★★★★ <span className="text-gray-400 text-xs font-normal">(4.9)</span>
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="text-center p-6 rounded-2xl bg-white border border-blue-100/70 hover:bg-blue-50/80 hover:border-blue-200 shadow-xs hover:shadow transition-all">
                            ...
                            <p className="text-gray-600 mt-2 text-sm leading-relaxed">
                                100% secure payment gateways for a hassle-free shopping experience.
                            </p>
                        </div>
                        ...
                        <div className="text-center p-6 rounded-2xl bg-white border border-blue-100/70 hover:bg-blue-50/80 hover:border-blue-200 shadow-xs hover:shadow transition-all">
                            ...
                            <p className="text-gray-600 mt-2 text-sm leading-relaxed">
                                Hassle-free return and instant refund policy for all eligible products.
                            </p>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mt-4 text-sm leading-relaxed">
                            Your one-stop destination for quality lifestyle products at prices you love.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-2.5 text-sm text-gray-400">
                            <p><Link to="/" className="hover:text-orange-400 transition-colors">Home</Link></p>
                            <p><Link to="/productpage" className="hover:text-orange-400 transition-colors">Shop Products</Link></p>
                            <p><Link to="/categories" className="hover:text-orange-400 transition-colors">Categories</Link></p>
                            <p><Link to="/cart" className="hover:text-orange-400 transition-colors">Shopping Cart</Link></p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-2.5 text-sm text-gray-400">
                            <p className="hover:text-orange-400 transition-colors cursor-pointer">Contact Us</p>
                            <p className="hover:text-orange-400 transition-colors cursor-pointer">Shipping Policy</p>
                            <p className="hover:text-orange-400 transition-colors cursor-pointer">Return &amp; Refund</p>
                            <p className="hover:text-orange-400 transition-colors cursor-pointer">FAQs</p>
                        </div>
                    </div>
